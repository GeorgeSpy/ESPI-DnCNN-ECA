...
# -*- coding: utf-8 -*-
"""
batch_denoise_pytorch_v2.py
---------------------------
Same as batch_denoise_pytorch.py, but with optional prefilter:
--prefilter none|median3|bilateral

'bilateral' uses OpenCV if available (pip install opencv-python); otherwise falls back to median3.
"""
