...
#     --speckle-k 6.0 --speckle-theta 0.3 --poisson-gain 0.7 --gauss-sigma 0.01 --vignette 0.05 --jitter 0
...
def main():
    ...
    ap.add_argument("--speckle-k", type=float, default=6.0)
    ap.add_argument("--speckle-theta", type=float, default=0.3)
    ap.add_argument("--poisson-gain", type=float, default=0.7)
    ap.add_argument("--gauss-sigma", type=float, default=0.01)  # ~2.5/255
    ap.add_argument("--vignette", type=float, default=0.05)
