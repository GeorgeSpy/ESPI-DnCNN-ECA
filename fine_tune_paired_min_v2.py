#!/usr/bin/env python3
"""
fine_tune_paired_min_v2.py
- Paired fine-tune for DnCNN-Lite+ECA.
- Adds: --freeze-bn, --w-mse/--w-ssim/--w-edge, clamp[0,1], ReduceLROnPlateau,
        and saving small sample triplets (no torchvision dependency).
"""
...
def main():
    ...
    print("Then re-run your phase/QC to see downstream gains.")
